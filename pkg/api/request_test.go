...
func TestRequest_toHTTP(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			request:          &request{url: &url.URL{Scheme: "https", Host: "https://chemtrail.jrasell.com:8000"}, method: "GET"},
			expectedHTTPResp: generateRequest("GET", &url.URL{Scheme: "https", Host: "https://chemtrail.jrasell.com:8000"}),
			expectedError:    nil,
		},
	}
